 ...
 * 经过自动配置化脱敏后, 返回的json是: {"id": 123456789, "name": "东方不败", "phone": {key: 1213113131, value: "188****8888"}, password: {key: 1213113132, value: "******"}
...
public class SensitiveAutoConfiguration implements WebMvcConfigurer {
    ...
    public Derivator derivator() {
        return new CacheDerivator(10_000, 12, TimeUnit.HOURS);
    }
